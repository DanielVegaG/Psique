...
public class LoginProfActivity extends AppCompatActivity {
        ...
        b_generateVerifCode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(TextUtils.isEmpty(et_phone.getText().toString())){
                    Toast.makeText(LoginProfActivity.this, "Introduce un número de teléfono válido",Toast.LENGTH_SHORT).show();
                }else{
                    String phoneNumber=et_phone.getText().toString().replace(" ","");
                    sendVerifCode(phoneNumber);
                    Toast.makeText(LoginProfActivity.this, "SMS enviado", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        b_testVerifCode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(TextUtils.isEmpty(et_verifCode.getText().toString())){
                    Toast.makeText(LoginProfActivity.this, "Código de verificación incorrecto",Toast.LENGTH_SHORT).show();
                }else{
    ...
    mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        public void onVerificationFailed(@NonNull FirebaseException e) {
            Toast.makeText(LoginProfActivity.this,"Error en la verificación ", Toast.LENGTH_SHORT);
        }
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            Toast.makeText(LoginProfActivity.this,"R",Toast.LENGTH_SHORT);
                            startActivity(new Intent(LoginProfActivity.this,MenuActivity.class));
                        }
                    }
                });
    }
